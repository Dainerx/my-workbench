...
class AsciidocContentProvider {
    ...
    providePreviewHTML(asciidocDocument, previewConfigurations, initialLine = undefined, state) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const body = yield this.engine.render(sourceUri, config.previewFrontMatter === 'hide', asciidocDocument.getText());
